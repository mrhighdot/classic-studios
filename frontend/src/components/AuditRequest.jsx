...
const AuditRequest = () => {
  return (
    <div className="flex flex-col sm:flex-row px-8 py-6 sm:p-[6rem] text-white bg-[#303030] justify-between items-start">
      <div className="flex flex-col sm:flex-row items-start sm:gap-32 gap-4 justify-between">
